...
namespace Design_Dashboard_Modern
{
    public partial class Report : Form
    {
        ...
        public void LoadInfor()
        {
            ...
            tbNamSinh.Text = inf.NgaySinh.ToString("dd/MM/yyyy");
            tbChucVu.Text = inf.TenChucVu;
            tbHocHam.Text = inf.HocHamHocVi;
            cbBoMon_TieuDe_1.Text = inf.TenBoMon;
            cbBoMon.Text = inf.TenBoMon;
            cbKhoa_TieuDe_1.Text = inf.TenKhoa;
            numLuong.Text = inf.LuongThucNhan;
        }

        List<InforReportView> listRP;
        void LoadMonhoc()
        {
            string response = DataProvider.Instance.GetData("https://localhost:5001/api/GiangDay/"+ inf.IdgiangVien);
            listRP = JsonConvert.DeserializeObject<List<InforReportView>>(response.ToString());
            DataGridViewComboBoxColumn combo = new DataGridViewComboBoxColumn();
            combo.HeaderText = "Tên Môn Học";
            combo.Items.Add("sfdsfdsf");

            grHK1_MM.Columns.Add(combo);
        }
        ...
        private void lay_basic_infor()
        {
            ...
            GiangDay.khoa = cbKhoa_TieuDe_1.Text==null?"0": cbKhoa_TieuDe_1.Text;
            GiangDay.boMon = cbBoMon_TieuDe_1.Text == null ? "0" : cbBoMon_TieuDe_1.Text;
            ...
            GiangDay.chucVu = tbChucVu.Text == null ? "0" : tbChucVu.Text;
        ...
        private void dataGridView1_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            if(grHK1_MM.CurrentCell.ColumnIndex == 6|| grHK1_MM.CurrentCell.ColumnIndex == 5 || grHK1_MM.CurrentCell.ColumnIndex == 0)
            {
        ...
        {
            picCancle.ImageLocation = @"close.png";
        }

        private void pictureBox5_MouseEnter(object sender, EventArgs e)
        {
            picCancle.ImageLocation = @"close_1.png";
        }
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            tbTongTiet.Text = (GiangDay.thuc_giang_A + GiangDay.thuc_giang_B).ToString();
            tbTietPhaiGiang.Text = GiangDay.phai_giang_A.ToString();
            tbChuaHoanThanh.Text = ((GiangDay.phai_giang_A - GiangDay.thuc_giang_A) < 0 ? 0 : (GiangDay.phai_giang_A - GiangDay.thuc_giang_A)).ToString();
            tbTietOver.Text = ((GiangDay.phai_giang_A - GiangDay.thuc_giang_A) >= 0 ? 0 : (GiangDay.phai_giang_A - GiangDay.thuc_giang_A) * -1).ToString();
